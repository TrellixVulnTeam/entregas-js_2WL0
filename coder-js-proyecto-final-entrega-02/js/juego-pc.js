    ...
    case 'primera':
      ...
      if(quienEsMano == 'jugador'){
        ...
        if(indiceCartaMayor != -1){
          ...
          // indica que la PC gana primera
          localStorage.setItem('deQuienEsPrimera', 'PC');

          // si la PC gana, entonces sigue jugando
          localStorage.setItem('turnoActual', 'PC');
        ...
        // SI TIENE UNA CARTA DE IGUAL VALOR ***
          ...
          // indica que la mano queda parda
          localStorage.setItem('deQuienEsPrimera', 'parda');

          // si emparda, juega el jugador que es mano
        ...
        // Si no tiene MAYOR ni IGUAL, juega la **CARTA MAS BAJA**
          ...
          // indica que el jugador gana primera
          localStorage.setItem('deQuienEsPrimera', 'jugador');

          // si el jugador gana, entonces es su turno
          localStorage.setItem('turnoActual', 'jugador');
        
        }
        
        // cambio de manoActual, a segunda mano
        // ya que jugador juega primero (es mano)
        localStorage.setItem('manoActual', 'segunda');
      ...
      // si la PC es Mano, juega la carta mas alta
        ...
        // no se cambiad de mano, ya que PC juega primero (no es mano)
    ...
    case 'segunda':
      ...
      // Si primera mano es del *JUGADOR*, el ya jugó segunda
        ...
        if (indiceCartaMayorA != -1){
          ...
          // gana la segunda mano
          localStorage.setItem('deQuienEsSegunda', 'PC');
        
          // cambia la manoActual a tercera
          localStorage.setItem('manoActual', 'tercera');
          
        // si no tiene carta mayor, al tener primera perdida
        } else {
          
          // pierde segunda también 
          localStorage.setItem('deQuienEsSegunda', 'jugador');
